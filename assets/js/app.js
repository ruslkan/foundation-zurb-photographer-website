...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  var logo = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#promoLogo');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(logo).hide();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(logo).fadeIn(5000);
});
// End logo
...
var topMob = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#topMobile');
...
var prev = 0;
var $window = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window);
var nav = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#siteHeader');
$window.on('scroll', function () {
  var scrollTop = $window.scrollTop();
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#SearchToggleMobile').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#searchContainer').slideToggle('fast');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#searchContainer, #SearchToggleMobile').toggleClass('active');
  return false;
});
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).click(function (event) {
  ...
  if (!target.is('#SearchToggleMobile') && !target.closest('#searchContainer').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#searchContainer, #SearchToggleMobile').removeClass('active');
  }
});
...
// Handle click on toggle search button
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#SearchToggleDesktop').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#searchContainer').slideToggle('fast');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#searchContainer, #SearchToggleDesktop').toggleClass('active');
  return false;
});
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).click(function (event) {
  ...
  if (!target.is('#SearchToggleDesktop') && !target.closest('#searchContainer').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#searchContainer, #SearchToggleDesktop').removeClass('active');
  }
});
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('flip-card').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('flip-card__inner').addClass('hover').mouseleave(function () {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).scroll(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).scrollTop() > 300) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.scrollup').fadeIn();
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.scrollup').fadeOut();
    }
  });
...
module.exports = __webpack_require__(/*! /media/ridik/DEVELOPMENT_HDD2/html/foundation-zurb-photographer-website/src/assets/js/app.js */"./src/assets/js/app.js");
